  ...
  useEffect(() => {
    ...
    if (stripeParam === 'success') {
      ...
      checkStripeAccountStatus()
        ...
        .catch(() => {
          setError('No se pudo verificar la conexión con Stripe');
        })
    ...
    startTransition(async () => {
      try {
        ...
        if (result.success && result.url) {
          ...
          setError(result.error || 'No se pudo crear la conexión con Stripe');
        }
      } catch {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <h3 className="text-lg font-semibold">Aceptar pagos en línea</h3>
        ...
        <div className="space-y-6">
          {verifying ? (
            <div className="border rounded-lg p-6 text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground">Verificando la conexión con Stripe...</p>
            </div>
          ) : stripeConnected ? (
            <div className="border rounded-lg p-6 text-center space-y-4 bg-green-50 dark:bg-green-950 border-green-200 dark:border-green-800">
              ...
              <h4 className="font-semibold text-green-700 dark:text-green-300">¡Stripe conectado!</h4>
            ...
            <div className="border rounded-lg p-6 text-center space-y-4">
              ...
              <h4 className="font-semibold">Conectar con Stripe</h4>
          ...
          <p className="text-sm text-muted-foreground text-center">
            Puede omitir este paso y configurar los pagos después en Configuración
          </p>
        </div>
      ) : (
        <div className="border rounded-lg p-6 text-center space-y-4 bg-muted/50">
          <h4 className="font-semibold">Stripe no está configurado</h4>
          <p className="text-sm text-muted-foreground max-w-md mx-auto">
            El procesamiento de pagos en línea requiere configurar las claves de Stripe. Puede hacerlo más adelante agregándolas a las variables de entorno.
          </p>
        </div>
      )}
